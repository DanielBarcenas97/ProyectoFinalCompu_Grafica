...
void applicationLoop() {
	...
	while (psi) {
		...
		//Numero de luces a utilizar de tipo poinlights=3
			...
			//107 Amarilla
			shaderMulLighting.setVectorFloat3("pointLights[107].position", glm::value_ptr((glm::vec3(21.0 + suma - 4.5, -6.5, -7.7 - 15.5))));
			...
			//108
			shaderMulLighting.setVectorFloat3("pointLights[108].position", glm::value_ptr((glm::vec3(17.0 + suma, -6.5, -7.7 - 15.5))));
			...
			//109
			shaderMulLighting.setVectorFloat3("pointLights[109].position", glm::value_ptr((glm::vec3(13.0 + suma, -6.5, -7.7 - 15.5))));
